...
## NOTE: Choose one and do not forget to restart colab runtime if you are switching between models
"""
...
print('=' * 70)
print('Euterpe X Standard Improv Model Generator')
print('=' * 70)
...
print('=' * 70)
print('Euterpe X Inpainting Model Generator')
print('=' * 70)
...
print('=' * 70)
print('Euterpe X Melody Harmonization Model Generator')
