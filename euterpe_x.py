...
Original file is located at
    https://colab.research.google.com/drive/1wHJkJbxmzrVeUxxEkUTX5QlcNVY1K01Z
...
# %cd /content/
print('=' * 70)
print('Loading aux Euterpe X modeules...')
...
full_path_to_model_checkpoint = "/content/Euterpe-X/Model/Euterpe_X_Trained_Model_46000_steps_0.5737_loss.pth" #@param {type:"string"}
...
#@markdown NOTE: These are strong suggestions to the model. Some combinations may not work well.
...
if len(events_matrix1) > 0 and len(instruments_list_without_drums) > 0:
  ...
  for e in events_matrix1:
    if e[1] >= 0 and e[2] > 0:
      ...
      # Writing final note 
      melody_chords.append([tim, dur, cha, ptc])
...
number_of_generation_attempts_per_melody_note = 4 #@param {type:"slider", min:1, max:64, step:1}
temperature = 0.8 #@param {type:"slider", min:0.1, max:1, step:0.1}

print('=' * 70)
print('Euterpe X Advanced Melody Harmonization Model Generator')
