# -*- coding: utf-8 -*-
"""Euterpe_X_Maker.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1gKFa2JAcw2scL_MBnryJN6F-LSkVKyec

# Euterpe X Maker (ver. 0.5)
...
for i in tqdm.tqdm(range(NUM_BATCHES), mininterval=10., desc='Training'):
    ...
    if i % SAVE_EVERY == 0:
        ...
        fname = home_dir+'/model_checkpoint_'  + str(i) + '_steps_' + str(round(float(train_losses[-1]), 4)) + '_loss.pth'
        
        torch.save(model.state_dict(), fname)
        
        data = [train_losses, train_accs, val_losses, val_accs]

        TMIDIX.Tegridy_Any_Pickle_File_Writer(data, home_dir+'/losses_accs')
...
plt.savefig(home_dir+'/training_loss_graph.png')
plt.close()
print('Done!')
...
plt.savefig(home_dir+'/training_acc_graph.png')
plt.close()
print('Done!')
...
plt.savefig(home_dir+'//validation_loss_graph.png')
plt.close()
print('Done!')
...
plt.savefig(home_dir+'/validation_acc_graph.png')
plt.close()
print('Done!')
