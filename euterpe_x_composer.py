...
Original file is located at
    https://colab.research.google.com/drive/15MaRQo2oVjlyPHrxPJkUaX5KXm0d51BO

# Euterpe X Composer (ver. 2.0)
...
number_of_prime_tokens = 402 #@param {type:"slider", min:126, max:2000, step:3}
...
if block_action == 'add_last_generated_block':
  ...
  melody_chords_f = melody_chords_f[:(len(melody_chords_f)-402)]
  print('Block removed!')
